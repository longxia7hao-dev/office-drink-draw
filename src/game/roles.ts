...
export const ROLES: RoleDef[] = [
  ...
  },
  {
    ...
    drink: "{P}",
    skillName: "摸魚",
    skillDesc: "本次懲罰完全免除（但下次被懲罰時會被抓到摸魚！懲罰加倍）。",
    skillKind: "slacker",
    color: "#4ECDC4",
    icon: "worker",
  ...
  },
  {
    ...
    drink: "{P}（可減半）",
    skillName: "新人保護期",
    skillDesc: "可以免除任何懲罰！但要幫其他人做一件事（由其他玩家共同指派）。",
    skillKind: "protect",
    color: "#A78BFA",
    icon: "intern",
  ...
  },
  {
    ...
    drink: "{P}",
    skillName: "能者多勞",
    skillDesc: "這次懲罰免除，陪同下一回合受懲罰的人一同接受懲罰。",
    skillKind: "able",
    color: "#38BDF8",
    icon: "hr",
  ...
  },
  {
    ...
    drink: "{P}",
    skillName: "風險對沖",
    skillDesc: "若自己連續兩次受罰，可將第二次懲罰指派給其他玩家。",
    skillKind: "hedge",
    color: "#34D399",
    icon: "accountant",
  ...
  },
  {
    ...
    drink: "{P}",
    skillName: "緊急備援",
    skillDesc: "可幫助其他玩家把懲罰減半。下次自己受罰時，由對方自動分攤一半（不可選擇）。",
    skillKind: "backup",
    color: "#60A5FA",
    icon: "engineer",
  ...
  },
  {
    ...
    drink: "{P}",
    skillName: "替你擋酒",
    skillDesc: "當其他玩家受罰時，可替他承擔該次懲罰；之後你受罰時，可選擇由該玩家代替你受罰（一次）。",
    skillKind: "cover",
    color: "#FF5AD5",
    icon: "secretary",
    bio: "擋酒是專業，記帳是本能。",
